...
import AIService from './services/AIService'; // ✅ Importar el servicio de IA
...
const handleOk = () => {
  ...
  setTimeout(() => {
    ...
    const assessment = AIService.evaluateBankingAsset(newData.activo);

    addNewRow(newData.activo, assessment.riesgo, assessment.impacto, assessment.tratamiento);
    
    setIsModalVisible(false);
    setIsLoading(false);
    setSuggestEnabled(true);
    message.success(`Activo "${newData.activo}" evaluado con IA`);
  }, 1000);
};
